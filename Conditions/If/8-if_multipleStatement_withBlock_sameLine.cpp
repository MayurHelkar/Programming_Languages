...
void trueStatementExecution(void)
{
    ...
    if(1) { cout << "If statement : True" << endl; cout << "Same True Block Execution 2nd line" << endl; }
...
void falseStatementExecution(void)
{
    ...
    if(0) { cout << "If statement : False" << endl; cout << "Same True Block Execution 2nd line" << endl; }
