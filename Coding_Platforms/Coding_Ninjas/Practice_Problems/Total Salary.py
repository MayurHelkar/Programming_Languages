...
Input format
The only line of input contains an integer and a string separated by a single space.

Output Format:
The only line of the output prints the total salary.
...
basic_salary, grade = input().split()
