...
# print("The name of the person is ", person_name, end = ' ')
# print("and the age is ", person_age, end = ".")

print("The name of the person is", person_name, '', "and the age is", person_age, end = ".")